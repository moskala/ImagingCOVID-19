...
# # glcm
flds = [os.path.join(r"C:\Users\Maya\studia\4rok\inz\covidSeg\Train\Train - big", fold) for fold in
        os.listdir(r"C:\Users\Maya\studia\4rok\inz\covidSeg\Train\Train - big")]
...
# haralick
e = ImageEnsemble([os.path.join(r"C:\Users\Maya\studia\4rok\inz\repo\covidSeg\cs", fold) for fold in
                   os.listdir(r"C:\Users\Maya\studia\4rok\inz\repo\covidSeg\cs")], gotFolders=True)
e.MakeDicoms()
e.GetLungs()
h = Haralick(e.lungs)
haralickFts = h.GetHaralickFtsAll()
